...
{
    public abstract class CurveControl : UserControl
    {
        ...
        {
            Color colorSolid = Color.FromArgb(255, ForeColor);
            Color colorGuide = Color.FromArgb(128, ForeColor);
            Color colorGrid = Color.FromArgb(96, ForeColor);
            ...
            for (int c = 0; c < channels; ++c)
            {
                ...
                Color colorSelected = color.Blend(Color.White, 128);
